...
struct StoryBrain {
  ...
  mutating func nextStory(userChoice: String) {
    let currectStory = stories[storyNumber]
    if userChoice == currectStory.choice1 {
      storyNumber = currectStory.choice1Destination
    } else {
      storyNumber = currectStory.choice2Destination
    }
  }
